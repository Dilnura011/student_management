...
<div class="form-container">
    ...
    <form action="update.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="subject" name="subject" required value="<?= $student['subject'] ?>">
        </div>
        ...
        <div class="form-group">
            <label for="address">Exprience</label>
            <textarea id="exprience" name="exprience"><?= $student['exprience'] ?></textarea>
        </div>
